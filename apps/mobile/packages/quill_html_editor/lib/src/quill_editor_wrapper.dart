          ...
          function replaceSelection(replaceText) {
           ...
           applyGoogleKeyboardWorkaround(quilleditor);
            ...
            try{
               ...
               // Quill 2.0: directly set root innerHTML for reliable HTML rendering.
               // dangerouslyPasteHTML in Quill 2.0-dev.3 may render tags as literal
               // text in some environments. root.innerHTML + update() is more reliable.
               quilleditor.root.innerHTML = htmlString;
               quilleditor.update();
            }catch(e){
               console.log('setHtmlText', e);
               // fallback
               try { quilleditor.clipboard.dangerouslyPasteHTML(htmlString); } catch(e2) {}
            }
