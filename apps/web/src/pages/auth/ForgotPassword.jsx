...
import { Eye, EyeOff, FileText, Users, BarChart3, ArrowLeft } from "lucide-react";
          ...
          <div className="relative w-full bg-white rounded-3xl shadow-2xl px-8 py-10">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-center gap-1.5 text-sm">
                <Link to="/login" className="inline-flex items-center gap-1.5 font-medium hover:opacity-80" style={{ color: COLORS.cyan }}>
